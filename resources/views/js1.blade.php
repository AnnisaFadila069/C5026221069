...
<div class="container">
    ...
    <div class="form-group">
        ...
        <input type="number" id="bil1" placeholder="Masukkan bilanan pertama" class="form-control">
    </div>
    <div class="form-group">
        <label for="bil2">Bilangan 2</label>
        <input type="number" id="bil2" placeholder="Masukkan bilanan kedua" class="form-control">
    </div>
    <div class="btn-group">
